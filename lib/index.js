...
function Xliff2JSON(options){
    ...
    this.xliffTemplate = options.xliffTemplate ||  'lib/xliff_template.xml';
}
...
Xliff2JSON.prototype.parseXliff = function(xliff,cb){
    ...
    this.parser.parseString(xliff, function (err, json) {
        if (that.cleanJSON){
            that._parseXliffToCleanJSON(json,cb);
        }else{
            cb(json);
        }
    });
...
Xliff2JSON.prototype._parseXliffToCleanJSON = function(json,cb){
...
Xliff2JSON.prototype._parseJSONAndDecorate = function(json,options,cb){
   if (typeof json !== 'object'){
    ...
    var language = Object.keys(json)[0];
   var output={
      xliff: {
        "$": {
          "version":"1.0"
        ...
        "file":[{
            "$": {
              ...
              "target-language": options.destLanguage || language,
  ...
  var translations = json[language];
